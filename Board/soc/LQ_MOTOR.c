...
void Test_Enc(void)
{
    ...
    //printf("正交解码测试例程 \n");
    GPIO_ExtiInit(PTA19,rising_down);     //初始化A19,接Z相，每一圈进一次中断
    ...
    NVIC_SetPriority(PORTA_IRQn,NVIC_EncodePriority(NVIC_GetPriorityGrouping(),1,2));
